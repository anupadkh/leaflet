...
class Social {
	...
	protected static $table_name="social";
	public	$id, $name, $parent, $nepali;
  protected static $db_fields = array('id', 'name', 'parent', 'nepali');
  protected static $db_fields_nepali = array('क्र.म. सं.', 'नाम', '', 'नेपाली नाम');
