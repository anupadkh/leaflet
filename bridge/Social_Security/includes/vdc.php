...
class Vdc {
	...
	public	$id, $eng_name, $vcode, $nepl_name;
  protected static $db_fields = array('id', 'eng_name', 'vcode', 'nepl_name');
  protected static $db_fields_nepali = array('क्र.म. सं.', 'नाम', 'गाविसको कोड', 'नेपाली नाम');
  ...
  public static function find_current_vdcs(){
    return self::find_by_sql("SELECT * FROM ".self::$table_name." WHERE mun='0'");
  }
